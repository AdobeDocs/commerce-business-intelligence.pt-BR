...
description: Verifique o status do último ciclo de atualização do Commerce Intelligence diretamente do painel. Veja como as permissões de conta afetam o que você pode visualizar.
