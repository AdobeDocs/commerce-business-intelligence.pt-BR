...
description: Revise o esquema da tabela quote_item no Commerce Intelligence, que rastreia cada item do carrinho. Saiba mais sobre as recomendações da Adobe para gerenciar o tamanho da tabela ao longo do tempo.
...
| `product_type` | Tipo de produto adicionado ao carrinho. Os [tipos de produtos](https://experienceleague.adobe.com/pt-br/docs/commerce-admin/catalog/products/product-create#product-types) possíveis incluem: simples, configurável, agrupado, virtual, pacote e baixável |
