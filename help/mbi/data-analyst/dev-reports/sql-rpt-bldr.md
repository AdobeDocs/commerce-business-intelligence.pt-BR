...
Veja o [vídeo de treinamento](https://experienceleague.adobe.com/pt-br/docs/commerce-learn/tutorials/mbi/sql-report-builder) para saber mais.
...
![Demonstração animada de salvar um relatório SQL no painel](../../assets/SQL_Save_Report.gif)
