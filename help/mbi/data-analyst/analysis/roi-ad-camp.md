...
Antes de começarmos, [enviar um tíquete de suporte](../../guide-overview.md) para unir as seguintes dimensões à tabela de itens de linha (`sales\_flat\_order\_item, order\_item`):
