...
description: Crie um painel para monitorar os níveis de inventário atuais no Commerce Intelligence. As instruções abordam configurações de conta de arquitetura novas e herdadas.
