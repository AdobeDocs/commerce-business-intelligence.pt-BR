...
description: Conecte com segurança seu banco de dados MySQL ao Commerce Intelligence usando um túnel SSH. Recupere a chave pública, inclua na lista de permissões o endereço IP e configure os usuários.
