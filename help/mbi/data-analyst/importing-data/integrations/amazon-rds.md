...
description: Conecte seu banco de dados do Amazon RDS ao Commerce Intelligence. Siga as etapas de configuração para sincronizar dados de mecanismos de banco de dados RDS compatíveis com sua Data Warehouse.
