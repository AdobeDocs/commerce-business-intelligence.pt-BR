...
description: Conecte um banco de dados MySQL hospedado no cPanel ao Commerce Intelligence. Crie um usuário dedicado e insira os detalhes da conexão para começar a sincronizar seus dados.
