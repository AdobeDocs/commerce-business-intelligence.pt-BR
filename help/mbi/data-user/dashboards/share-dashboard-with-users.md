...
description: Compartilhe um painel do Commerce Intelligence com sua equipe para manter todos alinhados. Saiba mais sobre as recomendações da Adobe para conceder direitos de edição a alguns usuários selecionados.
