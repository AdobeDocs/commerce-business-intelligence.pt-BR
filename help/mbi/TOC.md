...
user-guide-title: Guia do usuário do Commerce Intelligence
...
- Analisar dados {#analyze}
   ...
   - Integrações de banco de dados {#integration}
      ...
      - [Verificação da chave do host SSH](data-analyst/importing-data/integrations/ssh-host-key-verification.md)
...
- Tutorials {#tutorials}
   ...
   - [Criando visualizações de uma consulta  [!DNL SQL] &#x200B;](tutorials/create-visuals-from-sql.md)
